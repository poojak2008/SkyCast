...
//  SkyCast
//
//  Created by pooja kamble on 11/07/26.
//
...
extension Color {
    ...
    static let apptabBarBorder = Color("Tab Bar Border").opacity(0.5)
    static let appforecastCardBackground = Color("Forecast Card Background")
    static let appProbabilityText = Color("Probability Text")
}
